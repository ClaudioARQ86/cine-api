...
// Configuración para actualizar los valores de un actor
...
// Configuración para eliminar una pelicula
async function HandleDeleteActorRequest(req, res) {
    ...
    try {
        ...
        .then((data) => {
            if (data.deletedCount === 0) return res.status(404).send('Actor no encontrado');
...
export { HandleInsertActorRequest, HandleGetActorsRequest, HandleGetActorByIdRequest, HandleGetActorsByPeliculaRequest, HandleUpdateActorRequest, HandleDeleteActorRequest }